...
# Location = ecommerce/extensions/payment/processors
...
class Razorpay(ApplePayMixin, BaseClientSidePaymentProcessor):
    NAME = 'razorpay'
    ...
    def __init__(self, site):
        ...
        self.api_secret = configuration['api_secret']
    ...
    def get_transaction_parameters(self, basket, request=None, use_client_side_checkout=True, **kwargs):
        raise NotImplementedError(
            'The Razorpay payment processor does not support transaction parameters.')
